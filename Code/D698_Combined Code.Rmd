...
#V1: Stopping metrics based on AUC score as preventing overfitting and added Cross-validation with Nfolds
...
#Version 2| RF
#Shortening max depth and trees for more conservative AUC. Applying the highest gini index features to the model
...
#creating a reference table w/ predicted probabilities, actuals, and predictions all in one
...
#see the first version tree structure
...
## Part 2 Analysis| Comparison of the Top LM model compared to the other two models

#Retrieve Top performing model and save it separately
